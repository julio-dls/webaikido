...
// Menu
define('MENU_BIENVENIDOS','WELCOME');
define('MENU_TECNICAS','TECHNIQUES');

// submenu
define('SUBMENU_MANOS','Hands');
define('SUBMENU_SOLO','Alone');
define('SUBMENU_PAREJAS','Couples');

define('SUBMENU_FAMILIA_SAITO','Familia Saito');
define('SUBMENU_AIKIDOKAS','Aikidokas');

define('SUBMENU_MOLDES','Molds');
define('SUBMENU_TARJETAS','Cards');
define('SUBMENU_VARIOS','Various');
// fin de submenu
...
define('VIDEO_FRASE','&quot; Your heart is full of fertile seeds waiting to sprout. In the same way that a lotus flower emerges from the mud to bloom in all its splendor, the interaction of the cosmic breath makes the spirit flourish so that it will bear fruit in this world &quot;. <br><cite> Morihei Ueshiba</cite>');
...
define('TITULO_BUSCAR','Search');
define('BUSCAR_NOMBRE','Name');
define('BOTON_CERRAR','Close');
define('BOTON_IMPRIMIR','Print');

define('BOTON_VER_MAS','See more ...');
define('BOTON_VER_MENOS','See less ...');

define('BTN_ENVIAR','Send Message');
define('INPUT_NOMBRE','Name');
define('INPUT_EMAIL','Email');
define('INPUT_ASUSNTO','Subject');
define('INPUT_MENSAJE','Message');

define('BOTON_PRIMERO','First');
define('BOTON_ULTIMO','Latest');

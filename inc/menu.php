          ...
          <ul class="nav navbar-nav main-nav  clear navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-left">
                <li><a href="gallery.php?categoria=poses/manosSimples">Manos Simples</a></li>
                <li role="separator" class="divider"></li>
                <li><a href="gallery.php?categoria=poses/posesSimples">Poses Simples</a></li>
                <li role="separator" class="divider"></li>
              </ul>
            </li>
            ...
            <li><a class="color_animation " href="gallery.php?categoria=hanmi">HANMI</a></li>
